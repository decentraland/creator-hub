...
# but still runs electron-builder to package the app the suite launches.
...
# build job); locally, run `make build-creator-hub` first. Without those the packaging
# step has nothing to bundle and the suite fails.
