...
export class Lever {
   ...
   * @param sound - Name of an audio file inside this smart item's folder (e.g. sound.mp3), played whenever the lever is flipped. Leave empty for no sound.
   * @param hoverText - Text shown when the player points at the lever.
   * @param onActivate - Action triggered every time the lever is activated.
   * @param onDeactivate - Action triggered every time the lever is deactivated.
   */
  constructor(
  ...
  start() {
    ...
    // The lever's state lives in a synced component so other players see it change.
  ...
  /**
   * Activates the lever if it is deactivated, or deactivates it if it is activated
   * @action
   */
  public toggle() {
