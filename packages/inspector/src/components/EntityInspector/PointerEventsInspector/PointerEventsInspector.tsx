...
export default withSdk<Props>(({ sdk, entity: entityId, initialOpen = true }) => {
  ...
  const [pointerEvents, addPointerEvent, updatePointerEvents, removePointerEvent] =
    useArrayState<PBPointerEvents_Entry>(
        ...
        <React.Fragment key={idx}>
          <Block label="Type">
            <Dropdown
              ...
              onChange={e =>
                handleStateChange({ eventType: mapValueToPointerEvent(e.target.value) }, idx)
              }
            />
          </Block>
          <Block label="Button">
            <Dropdown
              ...
              onChange={e =>
                handleEventInfoChange({ button: mapValueToInputAction(e.target.value) }, idx)
              }
            />
          </Block>
