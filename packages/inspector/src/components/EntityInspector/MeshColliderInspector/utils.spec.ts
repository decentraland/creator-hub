import type { PBMeshCollider, PBMeshCollider_CylinderMesh } from '@dcl/ecs';
...
import type { MeshColliderInput } from './types';
...
describe('toMeshCollider', () => {
  it('should convert to sphere mesh collider', () => {
    ...
    const result = toMeshCollider(value) as {
      ...
      mesh: { $case: 'sphere'; sphere: object };
    };
