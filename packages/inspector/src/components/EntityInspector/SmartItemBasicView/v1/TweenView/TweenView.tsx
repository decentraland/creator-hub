...
export default React.memo(
  withSdk<WithSdkProps & { entity: Entity }>(({ sdk, entity }) => {
    ...
    const [tweenComponent, setTweenComponentValue, isTweenComponentEqual] = useComponentValue(
      entity,
      Tween,
    );
    const [tweenSequenceComponent, setTweenSequenceComponentValue] = useComponentValue(
      entity,
      TweenSequence,
    );
      ...
      <>
        ...
        <Block>
          <RangeField
            ...
            label="Duration"
            value={duration / 1000}
            onChange={handleTweenChangeDuration}
          />
        </Block>
        <Block>
          <CheckboxField
            label="Auto Start"
            checked={isPlaying}
            onChange={handleTweenChangeAutoStart}
          />
          <CheckboxField
            label="Loop"
            checked={isLooping}
            onChange={handleTweenChangeLoop}
          />
        </Block>
      </>
    );
