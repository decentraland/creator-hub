...
import type { MeshRendererInput } from './types';
...
describe('toMeshRenderer', () => {
  it('should convert to sphere mesh', () => {
    ...
    const result = toMeshRenderer(value) as {
  ...
  it('should convert to cylinder mesh with radius', () => {
    ...
    const result = toMeshRenderer(value) as {
      mesh: { $case: 'cylinder'; cylinder: PBMeshRenderer_CylinderMesh };
    };
  ...
  it('should convert to plane mesh with uvs', () => {
    ...
    const result = toMeshRenderer(value) as {
      mesh: { $case: 'plane'; plane: PBMeshRenderer_PlaneMesh };
    };
