...
describe('getComponents', () => {
  it('returns sorted entity components and available components', () => {
    ...
    (engineMock.getComponent as vi.Mock).mockImplementation(mockActionComponent);
    (engineMock.componentsIter as vi.Mock).mockReturnValue(componentsIterMock);
...
describe('putComponentIds', () => {
  ...
  it('adds component ids for other components', () => {
    ...
    (engineMock.getComponent as vi.Mock).mockReturnValue(otherComponent);
...
describe('deleteComponentIds', () => {
  it('deletes component ids for ACTIONS component', () => {
    ...
    const componentsIterMock = POTENTIAL_COMPONENTS.map(($, id) =>
      mockComponent(
        $,
        $ === CoreComponents.ANIMATOR ? 999 : id,
