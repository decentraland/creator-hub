        ...
        return {
          material: {
            ...
            pbr: {
              ...
              albedoColor: value.albedoColor ? toColor4(value.albedoColor) : undefined,
              emissiveColor: value.emissiveColor ? toColor3(value.emissiveColor) : undefined,
              reflectivityColor: value.reflectivityColor
                ? toColor3(value.reflectivityColor)
                : undefined,
              texture: toTexture(base, value.texture),
              alphaTexture: toTexture(base, value.alphaTexture),
