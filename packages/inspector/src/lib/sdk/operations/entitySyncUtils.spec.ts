...
import {
  ...
  getEntitiesSyncStatus,
  removeSyncComponentsFromEntities,
} from './entitySyncUtils';
...
describe('entitySyncUtils', () => {
  ...
  describe('addSyncComponentsToEntities', () => {
    ...
    it('should update existing SyncComponents with new component IDs', () => {
      ...
      sdk.components.SyncComponents.create(entity, {
        componentIds: [sdk.components.Animator.componentId],
      });
      sdk.components.NetworkEntity.create(entity, {
      ...
      expect(sdk.components.SyncComponents.get(entity).componentIds).toEqual([
        sdk.components.Animator.componentId,
      ]);
      ...
      expect(sdk.components.SyncComponents.get(entity).componentIds).toContain(
        sdk.components.Animator.componentId,
      );
      expect(sdk.components.SyncComponents.get(entity).componentIds).toContain(
        sdk.components.States.componentId,
    ...
    it('should detect components implied by Actions', () => {
      ...
      const result = addSyncComponentsToEntities(
        ...
        [
          sdk.components.Animator.componentId,
          sdk.components.States.componentId,
          sdk.components.Tween.componentId,
        ],
      );
      ...
      expect(sdk.components.SyncComponents.get(entity).componentIds).not.toContain(
        sdk.components.Tween.componentId,
      );
    ...
    it('should prioritize Tween over Transform when adding both to a new SyncComponent', () => {
      ...
      expect(sdk.components.SyncComponents.get(entity).componentIds).not.toContain(
        sdk.components.Transform.componentId,
      );
    ...
    it('should not add Tween to SyncComponents that already contain Transform', () => {
      ...
      sdk.components.SyncComponents.create(entity, {
        componentIds: [sdk.components.Transform.componentId],
      });
      sdk.components.NetworkEntity.create(entity, {
        entityId: sdk.enumEntity.getNextEnumEntityId(),
        networkId: 0,
    ...
    it('should not add Transform to SyncComponents that already contain Tween', () => {
      ...
      sdk.components.SyncComponents.create(entity, {
        componentIds: [sdk.components.Tween.componentId],
      });
      sdk.components.NetworkEntity.create(entity, {
        entityId: sdk.enumEntity.getNextEnumEntityId(),
        networkId: 0,
  ...
  describe('removeSyncComponentsFromEntities', () => {
    ...
    it('should remove SyncComponents and NetworkEntity from entities', async () => {
      ...
      sdk.components.SyncComponents.create(entities[0], {
        componentIds: [sdk.components.Animator.componentId],
      });
      sdk.components.NetworkEntity.create(entities[0], {
        entityId: sdk.enumEntity.getNextEnumEntityId(),
        networkId: 0,
      });
  ...
  describe('getEntitiesSyncStatus', () => {
    it('should return sync status for entities', () => {
      ...
      sdk.components.NetworkEntity.create(entities[1], {
        entityId: sdk.enumEntity.getNextEnumEntityId(),
        networkId: 0,
      });
