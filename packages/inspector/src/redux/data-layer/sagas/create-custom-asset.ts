...
import type { IDataLayer } from '../index';
import { error, getAssetCatalog, getDataLayerInterface } from '../index';
import { ErrorType } from '../index';
import type { AssetData } from '../../../lib/logic/catalog';
import { isSmart } from '../../../lib/logic/catalog';
...
import type { CreateCustomAssetResponse } from '../../../tooling-entrypoint';
  ...
  try {
    ...
    const result: CreateCustomAssetResponse = yield call([dataLayer, 'createCustomAsset'], {
      ...
      thumbnail: action.payload.thumbnail
        ? transformBase64ResourceToBinary(action.payload.thumbnail)
        : undefined,
    });
